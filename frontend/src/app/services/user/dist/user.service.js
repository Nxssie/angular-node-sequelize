...
var apiUrl = "http://localhost:4000/api/users";
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.update = function (user, id) {
        var _this = this;
        return this.http.put(apiUrl + "/" + id, user, httpOptions).pipe(operators_1.tap(function (res) { return __awaiter(_this, void 0, void 0, function () {
